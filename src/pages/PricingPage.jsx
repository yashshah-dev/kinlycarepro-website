...
const PricingPage = () => {
  return (
    <>
      <SEO
        title="Pricing - From $39/month | NDIS Software"
        description="Affordable NDIS software pricing. Solo plan from $39/month. All plans include mobile apps, rostering, billing, and Guardian safety checks. 48-hour implementation."
