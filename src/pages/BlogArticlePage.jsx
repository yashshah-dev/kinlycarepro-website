...
const articles = {
  'ndis-progress-notes-guide': {
    ...
    image: guardianImage,
    imageAlt: 'Kinly CarePro Guardian AI progress note quality assurance interface',
    ...
    sections: [
      ...
      ['Example: make the record useful for the next worker', ['Instead of writing “participant was happy”, describe the relevant observable detail and support context. For example: “Participant chose the local library visit from two options. Staff provided transport and prompted use of the self-checkout. Participant borrowed two books and asked to return next Tuesday.”', 'The example does not prescribe a required format. It illustrates how context, support and the participant’s response can make a record more useful than a general conclusion. Use your organisation’s approved documentation process.']]
    ],
  ...
  'ndis-billing-guide': {
    ...
    image: billingImage,
    imageAlt: 'Kinly CarePro NDIS billing and invoicing dashboard',
    ...
    sections: [
      ...
      ['A practical monthly billing-control routine', ['At the start of the cycle, confirm that the people responsible for service delivery, records and billing know the cut-off dates and exception pathway used internally. During the cycle, resolve incomplete records or roster changes close to the event rather than leaving them until month end.', 'Before submission, complete the authorised review, retain the supporting record in the appropriate system and record any items held for clarification. After the cycle, review exceptions with operations and finance so recurring issues lead to a specific process or training improvement.']]
    ],
